...
PACKAGE_VERSION="$(execute sfdx force:package:version:create -p $PACKAGE_NAME -x -w 10 --codecoverage -u $DEV_HUB_ALIAS --json | jq '.result.SubscriberPackageVersionId' | tr -d '"')"
